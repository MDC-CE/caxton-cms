...
- [ ] Demand label when needed: `anticipated_demand` | `fast_decay_news` | `broken_url`

See also: `explain` topics **`proposals`**, **`reading-proposals`**, **`review-situations`**, **`broken-url`**.
