...
export const fieldEditors: Record<string, EditorType> = {
  ...
  "workshop:date.icon": "icon-picker",
  "workshop:duration.icon": "icon-picker",
  "workshop:countdown.background_image": "image-picker",
  "workshop:live.images[]": "image-picker",
  "workshop:seats.fallback_avatars[]": "image-picker",
  "workshop:seats.load_more_label": "text-input",
  "workshop:host.socials[].icon": "icon-picker",
  "workshop:host.socials[].url": "link-picker",
  "workshop:host.avatar_url": "image-picker",
